...
import { BarChart3, CreditCard, FileText, Inbox, Link2, Mail, MailPlus, PenLine, Sparkles, Workflow } from "lucide-react";
...
const AppSidebar: React.FC = () => {
  ...
  if (session) {
    ...
    // Workspace-level, and deliberately not capability-gated: the assistant it configures
    // powers Forms, Email AND Workflow, so it can't hang off any one of them.
    items.push({ icon: <Sparkles className="size-5" />, name: "AI", path: "/ai" });
  ...
  return (
    ...
    >
      <div
        className={`-mx-5 flex min-h-[76px] shrink-0 items-center gap-1 overflow-x-clip border-b border-gray-200 px-5 py-2 dark:border-gray-800 ${
