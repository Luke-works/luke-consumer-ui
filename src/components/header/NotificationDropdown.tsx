...
export default function NotificationDropdown({
  ...
  // No real notification feed yet — nothing unread to flag.
    ...
    <div className="relative">
      ...
      >
        ...
        <div className="flex flex-1 flex-col items-center justify-center gap-2 px-4 py-10 text-center">
          <span className="flex size-12 items-center justify-center rounded-full bg-gray-100 text-gray-400 dark:bg-white/5 dark:text-gray-500">
            <svg
              className="fill-current"
              width="22"
              height="22"
