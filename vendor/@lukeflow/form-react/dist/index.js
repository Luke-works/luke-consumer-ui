...
function Static({ entity }) {
  ...
  if (entity.type === "content" || entity.type === "html" || entity.type === "htmlElement") {
    ...
    return /* @__PURE__ */ jsx10("div", { className: "lf-content", "data-type": entity.type, dangerouslySetInnerHTML: { __html: html } });
  }
...
function RenderEntity({ id, schema, ctx }) {
  ...
  if (ft?.isStatic) return /* @__PURE__ */ jsx11(Static, { entity });
  if (ft?.isContainer) {
