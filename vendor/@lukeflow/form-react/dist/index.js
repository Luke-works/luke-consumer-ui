      ...
      /* @__PURE__ */ jsx9("tbody", { children: visibleRows.map((row, j) => {
        ...
        return /* @__PURE__ */ jsxs5("tr", { children: [
          cells.map((c) => {
            ...
            return /* @__PURE__ */ jsx9("td", { children: visible && /* @__PURE__ */ jsx9(
              GridCell,
              {
                type: c.type,
                value,
...
function GridCell({
  ...
  if (type === "selectBoxes") {
    ...
    return /* @__PURE__ */ jsx9("div", { className: "lf-cell-choices", role: "group", "aria-label": rest["aria-label"], children: opts.map((o) => /* @__PURE__ */ jsxs5("label", { className: "lf-cell-check", children: [
      /* @__PURE__ */ jsx9("input", { type: "checkbox", checked: selected.has(o.value), disabled, onChange: (e) => toggle(o.value, e.target.checked) }),
      " ",
      o.label
    ] }, o.value)) });
  }
  ...
  if (type === "file") {
    ...
    return /* @__PURE__ */ jsx9(FileField, { a11y, multiple: Boolean(a.multiple), value, disabled, onChange, entity: fileEntity, scope: scope ?? {} });
  }
  if (type === "signature") {
    return /* @__PURE__ */ jsx9(SignatureField, { a11y, value, disabled, onChange, penColor: typeof a.penColor === "string" ? a.penColor : void 0, allowType: Boolean(a.allowType) });
  }
  if (type === "textarea") {
...
function Static({ entity }) {
  ...
  if (entity.type === "heading") {
    ...
    const Tag = size;
    return /* @__PURE__ */ jsx9(Tag, { className: `lf-heading lf-heading--${size}`, children: text2 });
  }
...
function PanelBox({ entity, schema, ctx, Render }) {
  ...
  return /* @__PURE__ */ jsxs5(Wrapper, { className: `lf-container lf-panel lf-panel--${theme}`, "data-type": entity.type, "data-collapsed": collapsible && !open ? "" : void 0, children: [
...
function RenderEntity({ id, schema, ctx }) {
  ...
  if (ft?.isContainer) {
    ...
    return /* @__PURE__ */ jsxs6("div", { className: `lf-container${bordered ? " lf-container--bordered" : ""}`, "data-type": entity.type, children: [
