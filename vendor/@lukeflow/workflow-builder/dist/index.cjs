...
function TriggerConfig({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
    ...
    isForms ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { title: "Which form?", children: forms.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 12, color: "var(--wf-faint)", marginTop: 4 }, children: "No published forms yet \u2014 this fires for any form." }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", { style: control, value: formCode, onChange: (e) => setFormCode(e.target.value), children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "", children: "Any form" }),
      forms.map((f) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("option", { value: f.code, children: [
        f.name,
        " (",
        f.code,
        ")"
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Section, { title: "Trigger settings", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(KvEditor, { value: advancedConfig, onChange: (next) => setConfig(isForms && formCode ? { ...next, formCode } : next) }) })
  ] });
}
...
function WorkflowBuilder({ value, stepTypes, connections, forms, theme = "light", highlight, onChange, className }) {
  const palette = (0, import_react4.useMemo)(() => buildPalette(stepTypes.filter((s) => s.kind !== "trigger")), [stepTypes]);
  const triggerTypes = (0, import_react4.useMemo)(() => stepTypes.filter((s) => s.kind === "trigger"), [stepTypes]);
  const nativeInits = (0, import_react4.useMemo)(() => nativeInitiators(stepTypes), [stepTypes]);
  const connectionInits = (0, import_react4.useMemo)(() => connectionInitiators(connections ?? []), [connections]);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        onChange ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("aside", { style: { width: 210, overflowY: "auto", borderRight: "1px solid var(--wf-border)", padding: 10, background: "var(--wf-surface)" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(SectionHeading, { children: "Initiators" }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(SubHeading, { children: "Native initiators" }),
          nativeInits.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Hint, { children: "No native initiators available." }) : nativeInits.map((g) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(InitiatorGroupView, { group: g, trigger: value.trigger, onSelect: selectInitiator }, `native-${g.group}`)),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(SubHeading, { children: "Connection initiators" }),
          connectionInits.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Hint, { children: "Connect and activate an integration to add initiators." }) : connectionInits.map((g) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(InitiatorGroupView, { group: g, trigger: value.trigger, onSelect: selectInitiator }, `conn-${g.group}`)),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { height: 1, background: "var(--wf-border)", margin: "14px 0 10px" } }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(SectionHeading, { children: "Steps" }),
          palette.map((group) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { marginBottom: 10 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(SubHeading, { children: group.group }),
            group.items.map((item) => draggable(item.id, item.label, item.id))
          ] }, group.group)),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(SubHeading, { children: "Flow" }),
        ...
        onChange && (triggerSelected || selected) ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          ConfigModal,
          {
            ...
            children: triggerSelected ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(TriggerConfig, { trigger: value.trigger, triggers: triggerTypes, forms, onChange: setTrigger }) : selected ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
              NodeConfig,
              {
                doc: value,
                node: selected,
...
function SectionHeading({ children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { fontSize: 11, fontWeight: 700, letterSpacing: 0.5, textTransform: "uppercase", color: "var(--wf-fg)", margin: "0 0 8px" }, children });
}
function SubHeading({ children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { fontSize: 10, fontWeight: 600, textTransform: "uppercase", color: "var(--wf-muted)", margin: "10px 0 4px" }, children });
}
function Hint({ children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { fontSize: 11, color: "var(--wf-faint)", padding: "2px 0 4px" }, children });
}
function InitiatorGroupView({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { marginBottom: 6 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(SubHeading, { children: group.group }),
    group.items.map((item) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { color: active ? "var(--wf-accent)" : "var(--wf-faint)", fontSize: 11 }, children: active ? "\u25C9" : "\u25CB" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { minWidth: 0, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }, children: item.label })
          ]
        },
        item.key
      );
