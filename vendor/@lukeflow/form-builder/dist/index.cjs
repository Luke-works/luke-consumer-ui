    ...
    parsed.map((r, i) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "lf-logic-rule", role: "group", "aria-label": `Rule ${i + 1}`, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "lf-logic-then", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("select", { "aria-label": `Rule ${i + 1} action`, value: r.action, onChange: (e) => setRule(i, { action: e.target.value }), children: LOGIC_ACTIONS.map((act) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("option", { value: act, children: ACTION_LABELS[act] ?? capitalize(act) }, act)) }),
