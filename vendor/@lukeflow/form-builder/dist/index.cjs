...
function SettingsPanel({ builder, editors }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "lf-settings", "aria-label": "Field settings", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "lf-settings-panel", role: "tabpanel", "aria-label": `${active?.label ?? ""} settings`, children: active?.editors.map((ed) => {
      const ctx = {
        entity,
...
function Palette({ builder, extra }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "lf-palette", "aria-label": "Field palette", children: [
    ...
    groups.map(({ group, items }) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "lf-palette-group", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h5", { className: "lf-palette-group-title", children: group }),
        visible.map((p) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "button",
          {
            type: "button",
...
function CanvasDndProvider({ builder, children }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(DndContext.Provider, { value: dnd, children });
}
function Canvas({ builder }) {
  const { schema } = builder;
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "lf-canvas", "aria-label": "Form canvas", children: schema.root.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(RootDropzone, { empty: true }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("ol", { className: "lf-node-list", children: schema.root.map((id, i) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Node, { id, parentId: null, index: i, count: schema.root.length, builder, depth: 0 }, id)) }) });
}
function Node({
  id,
  parentId,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("li", { className: "lf-node", "data-depth": depth, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "lf-node-actions", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", "aria-label": `Move ${labelOf(entity)} up`, disabled: index === 0, onClick: () => builder.reorderField(parentId, index, index - 1), children: "\u2191" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", "aria-label": `Move ${labelOf(entity)} down`, disabled: index === count - 1, onClick: () => builder.reorderField(parentId, index, index + 1), children: "\u2193" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", "aria-label": `Duplicate ${labelOf(entity)}`, onClick: () => builder.duplicateField(id), children: "\u29C9" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", "aria-label": `Delete ${labelOf(entity)}`, onClick: () => builder.removeField(id), children: "\u2715" })
          ] })
        ]
      }
    ),
    isContainer && (children.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("ol", { className: "lf-node-list", children: children.map((cid, i) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Node, { id: cid, parentId: id, index: i, count: children.length, builder, depth: depth + 1 }, cid)) }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ContainerDropzone, { containerId: id, label: labelOf(entity) }))
  ] });
}
...
function FormBuilder({ initialSchema, onChange, extraFields, attributeEditors, className }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: `lf-builder ${className ?? ""}`, children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "lf-builder-toolbar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", onClick: b.undo, disabled: !b.canUndo, "aria-label": "Undo", children: "Undo" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", onClick: b.redo, disabled: !b.canRedo, "aria-label": "Redo", children: "Redo" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", onClick: () => setShowPreview((p) => !p), "aria-pressed": showPreview, children: showPreview ? "Edit" : "Preview" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ProblemsBadge, { builder: b })
    ] }),
    showPreview ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "lf-builder-preview", "data-testid": "preview", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_form_react.FormRenderer, { schema: b.schema }) }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(CanvasDndProvider, { builder: b, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "lf-builder-body", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Palette, { builder: b, extra: extraFields }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Canvas, { builder: b }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(SettingsPanel, { builder: b, editors })
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Problems, { builder: b })
  ] });
}
function ProblemsBadge({ builder }) {
  const n = builder.problems.length;
  if (n === 0) return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "lf-problems-badge is-ok", children: "No problems" });
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: `lf-problems-badge${builder.hasErrors ? " is-error" : " is-warning"}`, children: [
    n,
    " problem",
    n === 1 ? "" : "s"
  ] });
...
function Problems({ builder }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "lf-problems", role: "region", "aria-label": "Problems", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("ul", { children: builder.problems.map((d, i) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("li", { className: `lf-problem is-${d.severity}`, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("button", { type: "button", disabled: !d.entityId, onClick: () => d.entityId && builder.select(d.entityId), children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "lf-problem-code", children: d.code }),
    " ",
    d.message
  ] }) }, i)) }) });
}
