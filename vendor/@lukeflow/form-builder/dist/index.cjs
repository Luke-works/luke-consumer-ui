...
function LogicRules({ builder, id, entity }) {
  ...
  (0, import_react2.useEffect)(() => setParsed(readRules()), [id]);
  const commit = (next) => {
    setParsed(next);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("fieldset", { className: "lf-settings-logic", children: [
    ...
    parsed.map((r, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "lf-logic-rule", role: "group", "aria-label": `Rule ${i + 1}`, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "lf-logic-when-head", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "lf-logic-when", children: "When" }),
        r.conds.length > 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", { className: "lf-logic-join-sel", "aria-label": `Rule ${i + 1} match`, value: r.join, onChange: (e) => setRule(i, { join: e.target.value }), children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "and", children: "all of (AND)" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "or", children: "any of (OR)" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "of these:" })
        ] })
      ] }),
      r.conds.map((c, j) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "lf-logic-cond", children: [
        j > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "lf-logic-join", children: r.join === "and" ? "AND" : "OR" }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "lf-logic-then", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "lf-logic-rule-remove", "aria-label": `Remove rule ${i + 1}`, onClick: () => commit(parsed.filter((_, j) => j !== i)), children: "Remove rule" })
      ] })
    ] }, i)),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "lf-logic-add", onClick: () => commit([...parsed, { join: "and", conds: [{ field: fields[0] ?? "", op: "==", value: "" }], action: "show", setTo: "" }]), children: "Add rule" })
  ] });
}
function emptyCond() {
