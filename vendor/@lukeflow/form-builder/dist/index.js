...
// src/FormBuilder.tsx
import { useMemo as useMemo6, useState as useState11, useEffect as useEffect10, useRef as useRef8, useImperativeHandle, forwardRef } from "react";
import { createPortal as createPortal3 } from "react-dom";

// src/SettingsPanel.tsx
import { useEffect as useEffect5, useId as useId2, useRef as useRef4, useState as useState6 } from "react";

// src/attributeEditors.ts
import { createDefaultFieldTypeRegistry as createDefaultFieldTypeRegistry2, PAYMENT_TYPE as PAYMENT_TYPE2 } from "@lukeflow/form-core";
...
function JsControl({ editor, ctx }) {
  ...
  return /* @__PURE__ */ jsxs2("details", { className: "lf-js", open, onToggle: (e) => setOpen(e.target.open), children: [
    /* @__PURE__ */ jsx2("summary", { className: "lf-js-summary", children: editor.label ?? editor.id }),
    /* @__PURE__ */ jsxs2("div", { className: "lf-js-body", children: [
      /* @__PURE__ */ jsx2(
        "textarea",
        {
          ref,
      ...
      /* @__PURE__ */ jsxs2("div", { className: "lf-js-insert", children: [
        /* @__PURE__ */ jsx2("span", { className: "lf-js-insert-label", children: "Insert:" }),
        tokens.map((t) => /* @__PURE__ */ jsx2("button", { type: "button", className: "lf-js-token", title: `Insert ${t.trim()}`, onClick: () => insert2(t), children: t.trim() }, t))
      ] }),
...
function ExpressionControl({ editor, ctx }) {
  ...
  return /* @__PURE__ */ jsx2(
    Labeled,
    {
      ...
      hint: editor.hint,
      footer: error ? /* @__PURE__ */ jsx2("span", { className: "lf-expr-error", role: "alert", children: error }) : void 0,
...
function DataSourceControl({ editor, ctx }) {
  ...
  return /* @__PURE__ */ jsxs2("fieldset", { className: "lf-settings-minion", children: [
    /* @__PURE__ */ jsx2("legend", { children: editor.label ?? "Minion data source" }),
    /* @__PURE__ */ jsxs2("label", { className: "lf-setting lf-setting-inline", children: [
      /* @__PURE__ */ jsx2(
        "input",
        {
          type: "checkbox",
      ...
      /* @__PURE__ */ jsx2("span", { className: "lf-setting-label", children: "Load options from a Minion" })
    ] }),
    editor.hint && /* @__PURE__ */ jsx2("span", { className: "lf-setting-hint", children: editor.hint }),
    enabled && /* @__PURE__ */ jsxs2(Fragment2, { children: [
      /* @__PURE__ */ jsx2(Labeled, { label: "Minion operation", children: /* @__PURE__ */ jsx2("input", { value: str(ds?.minion), placeholder: "listCities", onChange: (e) => set({ minion: e.target.value }) }) }),
      isSearch && /* @__PURE__ */ jsx2(Labeled, { label: "Search param", children: /* @__PURE__ */ jsx2("input", { value: str(ds?.searchParam), placeholder: "q", onChange: (e) => set({ searchParam: e.target.value }) }) }),
      /* @__PURE__ */ jsx2(Labeled, { label: "Result path", children: /* @__PURE__ */ jsx2("input", { value: str(ds?.resultPath), placeholder: "data", onChange: (e) => set({ resultPath: e.target.value }) }) }),
      /* @__PURE__ */ jsx2(Labeled, { label: "Label path", children: /* @__PURE__ */ jsx2("input", { value: str(ds?.labelPath), placeholder: "name", onChange: (e) => set({ labelPath: e.target.value }) }) }),
      /* @__PURE__ */ jsx2(Labeled, { label: "Value path", children: /* @__PURE__ */ jsx2("input", { value: str(ds?.valuePath), placeholder: "id", onChange: (e) => set({ valuePath: e.target.value }) }) }),
      !isSearch && /* @__PURE__ */ jsx2(Labeled, { label: "Refetch", children: /* @__PURE__ */ jsxs2("select", { value: str(ds?.trigger) || "load", onChange: (e) => set({ trigger: e.target.value }), children: [
        /* @__PURE__ */ jsx2("option", { value: "load", children: "Once on load" }),
        /* @__PURE__ */ jsx2("option", { value: "change", children: "When params change" })
      ] }) }),
      /* @__PURE__ */ jsx2(
        ParamsEditor,
        {
...
function AsyncValidationControl({ editor, ctx }) {
  ...
  return /* @__PURE__ */ jsxs2("fieldset", { className: "lf-settings-minion", children: [
    /* @__PURE__ */ jsx2("legend", { children: editor.label ?? "Async validation" }),
    /* @__PURE__ */ jsxs2("label", { className: "lf-setting lf-setting-inline", children: [
      /* @__PURE__ */ jsx2(
        "input",
        {
      ...
      /* @__PURE__ */ jsx2("span", { className: "lf-setting-label", children: "Validate via a Minion" })
    ] }),
    editor.hint && /* @__PURE__ */ jsx2("span", { className: "lf-setting-hint", children: editor.hint }),
    enabled && /* @__PURE__ */ jsxs2(Fragment2, { children: [
      /* @__PURE__ */ jsx2(Labeled, { label: "Minion operation", children: /* @__PURE__ */ jsx2("input", { value: str(av?.minion), placeholder: "checkEmail", onChange: (e) => set({ minion: e.target.value }) }) }),
      /* @__PURE__ */ jsx2(Labeled, { label: "Error message", children: /* @__PURE__ */ jsx2("input", { value: str(av?.message), placeholder: "Already taken", onChange: (e) => set({ message: e.target.value }) }) }),
      /* @__PURE__ */ jsx2(
        ParamsEditor,
        {
...
function ParamsEditor({
  ...
  return /* @__PURE__ */ jsxs2("fieldset", { className: "lf-settings-params", children: [
    /* @__PURE__ */ jsx2("legend", { children: legend }),
    rows.length === 0 && /* @__PURE__ */ jsx2("p", { className: "lf-empty", children: "No params." }),
    rows.map(([k, v], i) => /* @__PURE__ */ jsxs2("div", { className: "lf-param-row", role: "group", "aria-label": `Param ${i + 1}`, children: [
      /* @__PURE__ */ jsx2("input", { "aria-label": `Param ${i + 1} name`, value: k, placeholder: "param", onChange: (e) => setAt(i, e.target.value, v) }),
      /* @__PURE__ */ jsx2("span", { children: "\u2190" }),
      /* @__PURE__ */ jsxs2("select", { "aria-label": `Param ${i + 1} field`, value: v, onChange: (e) => setAt(i, k, e.target.value), children: [
        /* @__PURE__ */ jsx2("option", { value: "" }),
        fieldKeys.map((f) => /* @__PURE__ */ jsx2("option", { value: f, children: f }, f))
      ] }),
      /* @__PURE__ */ jsx2("button", { type: "button", "aria-label": `Remove param ${i + 1}`, onClick: () => commit(rows.filter((_, j) => j !== i)), children: /* @__PURE__ */ jsx2(IconX, { size: 13 }) })
    ] }, i)),
    /* @__PURE__ */ jsx2("button", { type: "button", className: "lf-param-add", onClick: () => commit([...rows, ["", ""]]), children: "Add param" })
  ] });
}
function Labeled({
  label,
  ...
  return /* @__PURE__ */ jsxs2("div", { className: "lf-setting-wrap", children: [
    /* @__PURE__ */ jsxs2("label", { className: `lf-setting${inline ? " lf-setting-inline" : ""}`, children: [
      /* @__PURE__ */ jsx2("span", { className: "lf-setting-label", children: label }),
      children
    ] }),
    hint && /* @__PURE__ */ jsx2("span", { className: "lf-setting-hint", children: hint }),
    footer
  ] });
}
...
var isPayment = (e) => e.type === PAYMENT_TYPE;
...
function MoneyInput({
  ...
  const shown = (m) => currency && typeof m === "number" && Number.isSafeInteger(m) ? toMajorString(m, currency) : "";
  const [text, setText] = useState3(() => shown(minor));
  useEffect2(() => {
    const parsed = currency ? toMinorUnits(text.trim(), currency) : null;
    if (parsed !== (typeof minor === "number" ? minor : null)) setText(shown(minor));
  }, [minor, currency?.code]);
  return /* @__PURE__ */ jsx3(Labeled, { label, hint: currency ? hint : "Choose a currency first.", children: /* @__PURE__ */ jsx3(
    "input",
    {
      inputMode: "decimal",
      value: text,
      disabled: !currency,
      placeholder: currency ? toMajorString(0, currency) : "",
      onChange: (e) => {
        ...
        if (next.trim() === "") onChange(void 0);
          ...
          const m = toMinorUnits(next.trim(), currency);
...
function sourceOptions(schema, allowed, currency) {
  ...
  for (const id of Object.keys(schema.entities ?? {}).sort()) {
    ...
    out.push({ key, label, problem: amountSourceProblem(schema, key, allowed, currency) });
  }
  return out;
}
function SourcePicker({
  ...
  return /* @__PURE__ */ jsx3(Labeled, { label, hint: options.length ? hint : emptyText, children: /* @__PURE__ */ jsxs3("select", { value: current, onChange: (e) => ctx.setValue(e.target.value || void 0), children: [
    /* @__PURE__ */ jsx3("option", { value: "", children: "\u2014" }),
    current && !listed && /* @__PURE__ */ jsx3("option", { value: current, children: `${current} (not found)` }),
    options.map((o) => /* @__PURE__ */ jsx3("option", { value: o.key, children: o.problem ? `${o.label} (${o.key}) \u2014 can't use: ${PROBLEM_TEXT[o.problem]}` : `${o.label} (${o.key})` }, o.key))
  ] }) });
}
var currencyFor = (ctx) => currencyOf(readPaymentAttributes(ctx.entity).currency);
function createPaymentEditors() {
  return [
    ...
    },
    {
      ...
      order: 2,
      appliesTo: [PAYMENT_TYPE],
      options: CURRENCY_CODES.map((c) => ({ label: c, value: c }))
    },
    {
      id: "paymentAmount",
      tab: "settings",
    ...
    },
    {
      ...
      order: 5,
      when: modeIs("perUnit"),
      hint: `The largest quantity one submission can pay for. Default ${DEFAULT_MAX_QUANTITY}.`
    },
    {
...
function exceptPayment(editor) {
  ...
  return { ...editor, when: (e, s) => e.type !== PAYMENT_TYPE2 && (inner ? inner(e, s) : true) };
}
...
function LogicRules({ builder, id, entity }) {
  ...
  const [parsed, setParsed] = useState4(readRules);
  const [testVals, setTestVals] = useState4({});
  useEffect3(() => {
    setParsed(readRules());
    setTestVals({});
  }, [id]);
  ...
  return /* @__PURE__ */ jsxs4("fieldset", { className: "lf-settings-logic", children: [
    /* @__PURE__ */ jsx4("legend", { children: "Conditional rules" }),
    parsed.length === 0 && /* @__PURE__ */ jsx4("p", { className: "lf-empty", children: "No rules." }),
    parsed.map((r, i) => {
      ...
      if (r.collapsed) {
        return /* @__PURE__ */ jsx4("div", { className: "lf-logic-rule is-collapsed", role: "group", "aria-label": `Rule ${i + 1}`, children: /* @__PURE__ */ jsxs4("div", { className: "lf-logic-summary", children: [
          /* @__PURE__ */ jsx4("span", { className: "lf-logic-summary-text", title: ruleSummary(r, meta), children: ruleSummary(r, meta) }),
          /* @__PURE__ */ jsx4("button", { type: "button", className: "lf-logic-iconbtn", title: "Edit rule", "aria-label": `Edit rule ${i + 1}`, onClick: () => setRule(i, { collapsed: false }), children: /* @__PURE__ */ jsx4(IconPencil, { size: 14 }) }),
          /* @__PURE__ */ jsx4("button", { type: "button", className: "lf-logic-iconbtn lf-logic-iconbtn--danger", title: "Remove rule", "aria-label": `Remove rule ${i + 1}`, onClick: () => removeRule(i), children: /* @__PURE__ */ jsx4(IconX, { size: 14 }) })
        ] }) }, r.id);
      }
      return /* @__PURE__ */ jsxs4("div", { className: "lf-logic-rule", role: "group", "aria-label": `Rule ${i + 1}`, children: [
        r.raw != null ? /* @__PURE__ */ jsxs4("div", { className: "lf-logic-advanced", children: [
          /* @__PURE__ */ jsx4("span", { className: "lf-logic-advanced-label", children: "When (advanced expression)" }),
          /* @__PURE__ */ jsx4("textarea", { className: "lf-code", "aria-label": `Rule ${i + 1} expression`, spellCheck: false, rows: 2, value: r.raw, onChange: (e) => setRule(i, { raw: e.target.value }) }),
          /* @__PURE__ */ jsx4("span", { className: "lf-setting-hint", children: "This expression can't be split into simple conditions \u2014 edit it directly." })
        ] }) : /* @__PURE__ */ jsxs4(Fragment3, { children: [
          /* @__PURE__ */ jsx4("div", { className: "lf-logic-when-head", children: /* @__PURE__ */ jsx4("span", { className: "lf-logic-when", children: "When" }) }),
          r.conds.map((c, j) => {
            const opts = c.field ? meta[c.field]?.options ?? [] : [];
            const editing = c.editing !== false;
            return /* @__PURE__ */ jsxs4("div", { className: `lf-logic-cond${editing ? "" : " is-readonly"}`, children: [
              j > 0 && (editing ? /* @__PURE__ */ jsxs4("select", { className: "lf-logic-conn", "aria-label": `Rule ${i + 1} condition ${j + 1} connector`, value: c.connector ?? "and", onChange: (e) => setCond(i, j, { connector: e.target.value }), children: [
                /* @__PURE__ */ jsx4("option", { value: "and", children: "AND" }),
                /* @__PURE__ */ jsx4("option", { value: "or", children: "OR" })
              ] }) : /* @__PURE__ */ jsx4("span", { className: "lf-logic-conn-text", children: c.connector === "or" ? "OR" : "AND" })),
              editing ? /* @__PURE__ */ jsxs4(Fragment3, { children: [
                /* @__PURE__ */ jsxs4("select", { "aria-label": `Rule ${i + 1} condition ${j + 1} field`, value: c.field, onChange: (e) => setCond(i, j, { field: e.target.value, value: "" }), children: [
                  /* @__PURE__ */ jsx4("option", { value: "" }),
                  fields.map((f) => /* @__PURE__ */ jsx4("option", { value: f, children: meta[f]?.label ?? capitalize(f) }, f))
                ] }),
                /* @__PURE__ */ jsx4("select", { "aria-label": `Rule ${i + 1} condition ${j + 1} operator`, value: c.op, onChange: (e) => setCond(i, j, { op: e.target.value }), children: LOGIC_OPS.map((o) => /* @__PURE__ */ jsx4("option", { value: o.op, children: o.label }, o.op)) }),
                opts.length > 0 ? /* @__PURE__ */ jsxs4("select", { "aria-label": `Rule ${i + 1} condition ${j + 1} value`, value: c.value, onChange: (e) => setCond(i, j, { value: e.target.value }), children: [
                  /* @__PURE__ */ jsx4("option", { value: "" }),
                  c.value && !opts.some((o) => o.value === c.value) && /* @__PURE__ */ jsxs4("option", { value: c.value, children: [
                    c.value,
                    " (not in options)"
                  ] }),
                  opts.map((o) => /* @__PURE__ */ jsx4("option", { value: o.value, children: o.label }, o.value))
                ] }) : /* @__PURE__ */ jsx4("input", { "aria-label": `Rule ${i + 1} condition ${j + 1} value`, value: c.value, onChange: (e) => setCond(i, j, { value: e.target.value }) }),
                /* @__PURE__ */ jsx4("button", { type: "button", className: "lf-logic-iconbtn lf-logic-iconbtn--ok", title: "Confirm condition", "aria-label": `Confirm condition ${j + 1} of rule ${i + 1}`, disabled: !c.field, onClick: () => setCond(i, j, { editing: false }), children: /* @__PURE__ */ jsx4(IconCheck, { size: 14 }) })
              ] }) : /* @__PURE__ */ jsxs4(Fragment3, { children: [
                /* @__PURE__ */ jsx4("span", { className: "lf-logic-cond-text", title: condText(c, meta), children: condText(c, meta) }),
                /* @__PURE__ */ jsx4("button", { type: "button", className: "lf-logic-iconbtn", title: "Edit condition", "aria-label": `Edit condition ${j + 1} of rule ${i + 1}`, onClick: () => setCond(i, j, { editing: true }), children: /* @__PURE__ */ jsx4(IconPencil, { size: 14 }) })
              ] }),
              /* @__PURE__ */ jsx4("button", { type: "button", className: "lf-logic-iconbtn lf-logic-iconbtn--danger", "aria-label": `Remove condition ${j + 1} of rule ${i + 1}`, title: "Remove condition", onClick: () => setRule(i, { conds: r.conds.filter((_, k) => k !== j) }), children: /* @__PURE__ */ jsx4(IconX, { size: 13 }) })
            ] }, c.id);
          }),
          /* @__PURE__ */ jsx4("button", { type: "button", className: "lf-logic-add-cond", onClick: () => setRule(i, { conds: [...r.conds, emptyCond()] }), children: "+ Add condition" })
        ] }),
        usedFields.length > 0 && /* @__PURE__ */ jsxs4("div", { className: "lf-logic-test", role: "group", "aria-label": `Rule ${i + 1} test`, children: [
          /* @__PURE__ */ jsx4("span", { className: "lf-logic-test-label", children: "Test:" }),
          usedFields.map((f) => {
            const v = testVals[r.id]?.[f] ?? "";
            return /* @__PURE__ */ jsxs4("label", { className: "lf-logic-test-field", children: [
              /* @__PURE__ */ jsx4("span", { className: "lf-logic-test-key", children: meta[f]?.label ?? capitalize(f) }),
              /* @__PURE__ */ jsx4("input", { "aria-label": `Rule ${i + 1} test ${f}`, className: "lf-logic-test-input", size: Math.max(4, v.length + 1), value: v, onChange: (e) => setTest(r.id, f, e.target.value) })
            ] }, f);
          }),
          /* @__PURE__ */ jsxs4("span", { className: `lf-logic-result${result ? " is-true" : " is-false"}`, "aria-live": "polite", children: [
            "\u21D2 ",
            result ? "true" : "false"
          ] })
        ] }),
        /* @__PURE__ */ jsxs4("div", { className: "lf-logic-then", children: [
          /* @__PURE__ */ jsx4("span", { className: "lf-logic-then-label", children: "\u2192 then" }),
          /* @__PURE__ */ jsxs4("div", { className: "lf-logic-actions-list", children: [
            r.actions.map((a, ai) => /* @__PURE__ */ jsxs4("div", { className: "lf-logic-action", children: [
              /* @__PURE__ */ jsx4("span", { className: "lf-logic-action-set", children: "set" }),
              /* @__PURE__ */ jsx4(
                "select",
                {
                  ...
                  children: ACTION_PROPERTIES.map((p) => /* @__PURE__ */ jsx4("option", { value: p.key, children: p.label }, p.key))
                }
              ),
              /* @__PURE__ */ jsx4("span", { className: "lf-logic-then-eq", "aria-hidden": "true", children: "=" }),
              a.action === "setValue" ? /* @__PURE__ */ jsxs4(Fragment3, { children: [
                /* @__PURE__ */ jsxs4("select", { "aria-label": `Rule ${i + 1} action ${ai + 1} value source`, value: a.setSource ?? "literal", onChange: (e) => setAction(i, ai, { setSource: e.target.value, setTo: "" }), children: [
                  /* @__PURE__ */ jsx4("option", { value: "literal", children: "a value" }),
                  /* @__PURE__ */ jsx4("option", { value: "field", children: "another field" })
                ] }),
                a.setSource === "field" ? /* @__PURE__ */ jsxs4("select", { "aria-label": `Rule ${i + 1} action ${ai + 1} set value`, value: a.setTo, onChange: (e) => setAction(i, ai, { setTo: e.target.value }), children: [
                  /* @__PURE__ */ jsx4("option", { value: "" }),
                  a.setTo && !fields.includes(a.setTo) && /* @__PURE__ */ jsxs4("option", { value: a.setTo, children: [
                    a.setTo,
                    " (not in fields)"
                  ] }),
                  fields.map((f) => /* @__PURE__ */ jsx4("option", { value: f, children: meta[f]?.label ?? capitalize(f) }, f))
                ] }) : /* @__PURE__ */ jsx4("input", { className: "lf-logic-setval", "aria-label": `Rule ${i + 1} action ${ai + 1} set value`, placeholder: "value to set", value: a.setTo, onChange: (e) => setAction(i, ai, { setTo: e.target.value }) })
              ] }) : /* @__PURE__ */ jsx4("select", { "aria-label": `Rule ${i + 1} action ${ai + 1} value`, value: a.action, onChange: (e) => setAction(i, ai, { action: e.target.value }), children: (ACTION_PROPERTIES.find((p) => p.key === propertyOf(a.action))?.options ?? []).map((o) => /* @__PURE__ */ jsx4("option", { value: o.action, children: o.label }, o.action)) }),
              r.actions.length > 1 && /* @__PURE__ */ jsx4("button", { type: "button", className: "lf-logic-iconbtn lf-logic-iconbtn--danger", "aria-label": `Remove action ${ai + 1} of rule ${i + 1}`, title: "Remove action", onClick: () => removeAction(i, ai), children: /* @__PURE__ */ jsx4(IconX, { size: 13 }) })
            ] }, a.id)),
            /* @__PURE__ */ jsx4("button", { type: "button", className: "lf-logic-add-cond", onClick: () => addAction(i), children: "+ Add action" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs4("div", { className: "lf-logic-rule-actions", children: [
          /* @__PURE__ */ jsxs4("button", { type: "button", className: "lf-logic-btn lf-logic-reset", title: "Reset this rule to its default", "aria-label": `Reset rule ${i + 1}`, onClick: () => resetRule(i), children: [
            /* @__PURE__ */ jsx4(IconReset, { size: 14 }),
            " Reset"
          ] }),
          /* @__PURE__ */ jsxs4("button", { type: "button", className: "lf-logic-btn lf-logic-save", title: "Save this rule (collapses it)", "aria-label": `Save rule ${i + 1}`, onClick: () => saveRule(i), children: [
            /* @__PURE__ */ jsx4(IconCheck, { size: 14 }),
            " Save"
          ] }),
          /* @__PURE__ */ jsxs4("button", { type: "button", className: "lf-logic-btn lf-logic-remove", title: "Remove this rule", "aria-label": `Remove rule ${i + 1}`, onClick: () => removeRule(i), children: [
            /* @__PURE__ */ jsx4(IconX, { size: 14 }),
            " Remove"
          ] })
        ] })
      ] }, r.id);
    }),
    /* @__PURE__ */ jsx4("button", { type: "button", className: "lf-logic-add", onClick: () => commit([...parsed, { id: lrUid(), conds: [{ id: lrUid(), field: fields[0] ?? "", op: "==", value: "", editing: true }], actions: [emptyAction()], collapsed: false }]), children: "Add rule" })
  ] });
}
function emptyCond() {
...
import { useEffect as useEffect4, useId, useRef as useRef3, useState as useState5 } from "react";
import { jsx as jsx5, jsxs as jsxs5 } from "react/jsx-runtime";
function OptionsControl({ editor, ctx }) {
  const [rows, setRows] = useState5(() => readOptionRows(ctx.value));
  const [shape, setShape] = useState5(() => inferShape(readOptionRows(ctx.value)));
  const [view, setView] = useState5("rows");
  const [draft, setDraft] = useState5("");
  const [jsonError, setJsonError] = useState5(null);
  const errId = useId();
  const sig = JSON.stringify(ctx.value ?? null);
  const lastSig = useRef3(sig);
  const lastId = useRef3(ctx.entity.id);
  const dirtyRef = useRef3(false);
  const pinnedRef = useRef3(false);
  const shapeRef = useRef3(shape);
  shapeRef.current = shape;
  const viewRef = useRef3(view);
  ...
  const seg = (active, label, onClick) => /* @__PURE__ */ jsx5("button", { type: "button", className: `lf-opt-mode-btn${active ? " is-active" : ""}`, "aria-pressed": active, onClick, children: label });
  return /* @__PURE__ */ jsxs5("div", { className: "lf-setting-wrap", children: [
    /* @__PURE__ */ jsxs5("div", { className: "lf-options-head", children: [
      /* @__PURE__ */ jsx5("span", { className: "lf-setting-label", children: editor.label ?? "Options" }),
      /* @__PURE__ */ jsxs5("div", { className: "lf-opt-toggles", children: [
        /* @__PURE__ */ jsxs5("div", { className: "lf-opt-mode", role: "group", "aria-label": "Options shape", children: [
          seg(shape === "list", "List", () => pickShape("list")),
          seg(shape === "kv", "Label + Value", () => pickShape("kv"))
        ] }),
        /* @__PURE__ */ jsxs5("div", { className: "lf-opt-mode", role: "group", "aria-label": "Options edit mode", children: [
          seg(view === "rows", "Rows", () => setView("rows")),
          seg(view === "json", "JSON", openJson)
        ] })
      ] })
    ] }),
    view === "rows" ? /* @__PURE__ */ jsxs5("div", { className: "lf-options", children: [
      rows.length === 0 && /* @__PURE__ */ jsx5("p", { className: "lf-empty", children: "No options yet." }),
      rows.map(
        (o, i) => shape === "kv" ? /* @__PURE__ */ jsxs5("div", { className: "lf-opt-row", children: [
          /* @__PURE__ */ jsx5("input", { "aria-label": `Option ${i + 1} label`, className: "lf-opt-label", value: o.label, placeholder: "Label", onChange: (e) => setField(i, { label: e.target.value }) }),
          /* @__PURE__ */ jsx5("input", { "aria-label": `Option ${i + 1} value`, className: "lf-opt-value", value: o.value, placeholder: "Value", onChange: (e) => setField(i, { value: e.target.value }) }),
          /* @__PURE__ */ jsx5("button", { type: "button", className: "lf-opt-remove", "aria-label": `Remove option ${i + 1}`, onClick: () => removeRow(i), children: /* @__PURE__ */ jsx5(IconX, { size: 13 }) })
        ] }, i) : /* @__PURE__ */ jsxs5("div", { className: "lf-opt-row", children: [
          /* @__PURE__ */ jsx5("input", { "aria-label": `Option ${i + 1}`, className: "lf-opt-label", value: o.label, placeholder: "Option", onChange: (e) => setLabel(i, e.target.value) }),
          /* @__PURE__ */ jsx5("button", { type: "button", className: "lf-opt-remove", "aria-label": `Remove option ${i + 1}`, onClick: () => removeRow(i), children: /* @__PURE__ */ jsx5(IconX, { size: 13 }) })
        ] }, i)
      ),
      /* @__PURE__ */ jsx5("button", { type: "button", className: "lf-opt-add", onClick: addRow, children: "+ Add option" })
    ] }) : /* @__PURE__ */ jsxs5("div", { className: "lf-options-json", children: [
      /* @__PURE__ */ jsx5(
        "textarea",
        {
      ...
      jsonError && /* @__PURE__ */ jsx5("p", { id: errId, className: "lf-opt-json-error", role: "alert", children: jsonError }),
      /* @__PURE__ */ jsxs5("div", { className: "lf-opt-json-foot", children: [
        /* @__PURE__ */ jsx5("button", { type: "button", className: "lf-opt-json-apply", onClick: applyJson, children: "Apply" }),
        /* @__PURE__ */ jsx5("span", { className: "lf-opt-json-hint", children: shape === "kv" ? 'A JSON array of { "label": "\u2026", "value": "\u2026" }.' : 'A JSON array of values \u2014 "Option A", "Option B", \u2026' })
      ] })
    ] }),
    editor.hint && /* @__PURE__ */ jsx5("span", { className: "lf-setting-hint", children: editor.hint })
  ] });
}
...
function SettingsPanel({ builder, editors }) {
  ...
  const [activeTab, setActiveTab] = useState6("display");
  ...
  if (!id || !entity) {
    return /* @__PURE__ */ jsx6("div", { className: "lf-settings", "aria-label": "Field settings", children: /* @__PURE__ */ jsx6("p", { className: "lf-empty", children: "Select a field to edit its settings." }) });
  }
  ...
  return /* @__PURE__ */ jsxs6("div", { className: "lf-settings", "aria-label": "Field settings", children: [
    /* @__PURE__ */ jsxs6("h4", { children: [
      "Settings \u2014 ",
      entity.type
    ] }),
    /* @__PURE__ */ jsx6("div", { className: "lf-settings-tabs", role: "tablist", "aria-label": "Field settings tabs", ref: navRef, children: groups.map((g) => /* @__PURE__ */ jsx6(
      "button",
      {
        type: "button",
        role: "tab",
    ...
    /* @__PURE__ */ jsx6("div", { className: "lf-settings-panel", role: "tabpanel", id: panelId, "aria-labelledby": active ? tabId(active.tab) : void 0, children: (() => {
      ...
      const renderEditor = (ed) => {
        ...
        return /* @__PURE__ */ jsx6(Control, { editor: ed, ctx, builder, id, entity }, `${id}:${ed.id}`);
      };
      const toggles = editorsHere.filter(isToggle);
      const rest = editorsHere.filter((ed) => !isToggle(ed));
      return /* @__PURE__ */ jsxs6(Fragment4, { children: [
        rest.map(renderEditor),
        toggles.length > 0 && /* @__PURE__ */ jsx6("div", { className: "lf-checkbox-group", role: "group", "aria-label": "Toggles", children: toggles.map(renderEditor) })
      ] });
    })() })
  ] });
}
function Control({
  ...
  if (editor.render) return /* @__PURE__ */ jsx6(Fragment4, { children: editor.render(ctx) });
  switch (editor.control) {
    case "logic":
      return /* @__PURE__ */ jsx6(LogicRules, { builder, id, entity });
    case "checkbox":
      return /* @__PURE__ */ jsx6(Labeled, { label: editor.label ?? editor.id, hint: editor.hint, inline: true, children: /* @__PURE__ */ jsx6("input", { type: "checkbox", checked: Boolean(ctx.value), onChange: (e) => ctx.setValue(e.target.checked) }) });
    ...
    case "exclude":
      return /* @__PURE__ */ jsx6(Labeled, { label: editor.label ?? editor.id, hint: editor.hint, inline: true, children: /* @__PURE__ */ jsx6("input", { type: "checkbox", checked: ctx.value === false, onChange: (e) => ctx.setValue(e.target.checked ? false : void 0) }) });
    case "number":
      return /* @__PURE__ */ jsx6(Labeled, { label: editor.label ?? editor.id, hint: editor.hint, children: /* @__PURE__ */ jsx6(
        "input",
        {
          type: "number",
    ...
    case "textarea":
      return /* @__PURE__ */ jsx6(Labeled, { label: editor.label ?? editor.id, hint: editor.hint, children: /* @__PURE__ */ jsx6("textarea", { value: str(ctx.value), placeholder: editor.placeholder, rows: 3, onChange: (e) => ctx.setValue(e.target.value) }) });
    case "select":
      return /* @__PURE__ */ jsx6(Labeled, { label: editor.label ?? editor.id, hint: editor.hint, children: /* @__PURE__ */ jsxs6("select", { value: str(ctx.value), onChange: (e) => ctx.setValue(e.target.value), children: [
        /* @__PURE__ */ jsx6("option", { value: "" }),
        (editor.options ?? []).map((o) => /* @__PURE__ */ jsx6("option", { value: o.value, children: o.label }, o.value))
      ] }) });
    case "options":
      return /* @__PURE__ */ jsx6(OptionsControl, { editor, ctx });
    case "tags":
      return /* @__PURE__ */ jsx6(Labeled, { label: editor.label ?? editor.id, hint: editor.hint, children: /* @__PURE__ */ jsx6(
        "input",
        {
    ...
    case "dataSource":
      return /* @__PURE__ */ jsx6(DataSourceControl, { editor, ctx });
    case "asyncValidation":
      return /* @__PURE__ */ jsx6(AsyncValidationControl, { editor, ctx });
    case "expression":
      return /* @__PURE__ */ jsx6(ExpressionControl, { editor, ctx });
    case "js":
      return /* @__PURE__ */ jsx6(JsControl, { editor, ctx });
    case "text":
    default:
      return /* @__PURE__ */ jsx6(Labeled, { label: editor.label ?? editor.id, hint: editor.hint, children: /* @__PURE__ */ jsx6("input", { value: str(ctx.value), placeholder: editor.placeholder, onChange: (e) => ctx.setValue(e.target.value) }) });
  }
}

// src/Canvas.tsx
import { createContext, useContext, useEffect as useEffect6, useId as useId3, useMemo as useMemo3, useRef as useRef5, useState as useState8 } from "react";
import { createDefaultFieldTypeRegistry as createDefaultFieldTypeRegistry5, createFormEngine } from "@lukeflow/form-core";

// src/NodePreview.tsx
import {
  createDefaultFieldTypeRegistry as createDefaultFieldTypeRegistry3,
  currencyOf as currencyOf2,
  readPaymentAttributes as readPaymentAttributes2,
  toMajorString as toMajorString2
} from "@lukeflow/form-core";
...
function NodePreview({ entity, field, components }) {
  ...
  const control = Custom ? /* @__PURE__ */ jsx7(CustomPreview, { Custom, entity, field }) : previewControl(entity, field);
  if (!Custom && ft?.isStatic) return /* @__PURE__ */ jsx7("div", { className: "lf-pv-static", children: control });
...
function CustomPreview({ Custom, entity, field }) {
  ...
  return /* @__PURE__ */ jsx7("div", { className: "lf-pv-custom", children: /* @__PURE__ */ jsx7(FormErrorBoundary, { fallback: /* @__PURE__ */ jsx7("span", { className: "lf-pv-muted", children: entity.type }), children: /* @__PURE__ */ jsx7(Custom, { entity, field: fs, value: fs.value, setValue: NOOP, disabled: true, error: null, id: `pv-${entity.id}` }) }) });
}
...
function previewControl(entity, field) {
  ...
  switch (entity.type) {
    case "textarea":
      return /* @__PURE__ */ jsx7("textarea", { className: "lf-pv-input", disabled: true, rows: typeof a.rows === "number" ? a.rows : 2, value: dv, placeholder: ph2 });
    case "number":
    case "currency":
    ...
    case "searchSelect": {
      ...
      return /* @__PURE__ */ jsxs7("select", { className: "lf-pv-input", disabled: true, children: [
        ph ? /* @__PURE__ */ jsx7("option", { children: ph }) : /* @__PURE__ */ jsx7("option", {}),
        opts.map((o, i) => /* @__PURE__ */ jsx7("option", { children: o.label }, i))
      ] });
    }
    case "radio":
    case "selectBoxes": {
      ...
      return /* @__PURE__ */ jsx7("div", { className: "lf-pv-choices", children: shown.slice(0, 4).map((o, i) => /* @__PURE__ */ jsxs7("label", { className: "lf-pv-check", children: [
        /* @__PURE__ */ jsx7("input", { type, disabled: true, checked: selected.has(o.value) }),
        " ",
        o.label
      ] }, i)) });
    }
    ...
    case "time":
      return a.nativeInput ? /* @__PURE__ */ jsx7("input", { className: "lf-pv-input", disabled: true, type: "time", value: dv }) : /* @__PURE__ */ jsxs7("span", { className: "lf-pv-datefield", children: [
        /* @__PURE__ */ jsx7("input", { className: "lf-pv-input", disabled: true, value: dv, placeholder: "HH:MM" }),
        /* @__PURE__ */ jsx7("span", { className: "lf-pv-cal", "aria-hidden": "true", children: "\u{1F551}" })
      ] });
    case "file":
      return /* @__PURE__ */ jsx7("div", { className: "lf-pv-file", children: "Choose file\u2026" });
    case "signature":
      return /* @__PURE__ */ jsx7("div", { className: "lf-pv-sign", children: "\u270E Signature" });
    case "tags":
    case "tagsField":
      return /* @__PURE__ */ jsx7("input", { className: "lf-pv-input", disabled: true, value: dv, placeholder: dv ? void 0 : ph || "Add tags\u2026" });
    case "button":
      return /* @__PURE__ */ jsx7("button", { className: "lf-pv-btn", type: "button", disabled: true, children: str2(a.label) || "Button" });
    case "heading": {
      const size = typeof a.headingSize === "string" && /^h[1-6]$/.test(a.headingSize) ? a.headingSize : "h3";
      return /* @__PURE__ */ jsx7("div", { className: `lf-pv-heading lf-pv-heading--${size}`, children: str2(a.label) || str2(a.content) || "Heading" });
    }
    case "content":
    case "html":
    case "htmlElement":
      return /* @__PURE__ */ jsx7("div", { className: "lf-pv-muted", children: str2(a.content) || "Content" });
    case "divider":
    case "hr":
      return /* @__PURE__ */ jsx7("hr", { className: "lf-pv-hr" });
    case "payment":
      return /* @__PURE__ */ jsxs7("div", { className: "lf-pv-payment", children: [
        "\u{1F4B3} ",
        paymentSummary(entity)
      ] });
    case "addressBlock":
      return /* @__PURE__ */ jsx7("div", { className: "lf-address", children: [
        ...
        ["country", "Country"]
      ].map(([key, label]) => /* @__PURE__ */ jsxs7("div", { className: `lf-address-part lf-address-${key}`, children: [
        /* @__PURE__ */ jsx7("label", { className: "lf-address-label", children: label }),
        /* @__PURE__ */ jsx7("input", { className: "lf-pv-input", disabled: true, type: "text", value: "", readOnly: true })
      ] }, key)) });
    default:
      return /* @__PURE__ */ jsx7("input", { className: "lf-pv-input", disabled: true, type: "text", value: dv, placeholder: ph2 });
  }
}
function paymentSummary(entity) {
  const cfg = readPaymentAttributes2(entity);
  const currency = currencyOf2(cfg.currency);
  if (!currency) return "Card payment \u2014 choose a currency";
  const money = (m) => typeof m === "number" && Number.isSafeInteger(m) && m > 0 ? `${toMajorString2(m, currency)} ${currency.code}` : null;
...
function Svg({ children }) {
  return /* @__PURE__ */ jsx8("svg", { className: "lf-palette-icon", viewBox: "0 0 24 24", width: "18", height: "18", "aria-hidden": "true", focusable: "false", children });
}
var box = /* @__PURE__ */ jsx8("rect", { x: "3", y: "6", width: "18", height: "12", rx: "2", ...S });
var ICONS = {
  textField: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("line", { x1: "4", y1: "9", x2: "20", y2: "9", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "4", y1: "14", x2: "13", y2: "14", ...S })
  ] }),
  textarea: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("rect", { x: "3", y: "5", width: "18", height: "14", rx: "2", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "6", y1: "9", x2: "18", y2: "9", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "6", y1: "12", x2: "18", y2: "12", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "6", y1: "15", x2: "13", y2: "15", ...S })
  ] }),
  email: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("rect", { x: "3", y: "6", width: "18", height: "12", rx: "2", ...S }),
    /* @__PURE__ */ jsx8("path", { d: "M4 8l8 6 8-6", ...S })
  ] }),
  url: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("path", { d: "M9 13a4 4 0 0 0 6 .5l2-2a4 4 0 0 0-6-6l-1 1", ...S }),
    /* @__PURE__ */ jsx8("path", { d: "M15 11a4 4 0 0 0-6-.5l-2 2a4 4 0 0 0 6 6l1-1", ...S })
  ] }),
  phoneNumber: /* @__PURE__ */ jsx8("path", { d: "M6 3h3l2 5-2 1a11 11 0 0 0 5 5l1-2 5 2v3a2 2 0 0 1-2 2A16 16 0 0 1 4 5a2 2 0 0 1 2-2z", ...S }),
  password: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("rect", { x: "5", y: "10", width: "14", height: "9", rx: "2", ...S }),
    /* @__PURE__ */ jsx8("path", { d: "M8 10V8a4 4 0 0 1 8 0v2", ...S })
  ] }),
  number: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("line", { x1: "9", y1: "4", x2: "7", y2: "20", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "17", y1: "4", x2: "15", y2: "20", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "4", y1: "9", x2: "20", y2: "9", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "4", y1: "15", x2: "20", y2: "15", ...S })
  ] }),
  currency: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("line", { x1: "12", y1: "3", x2: "12", y2: "21", ...S }),
    /* @__PURE__ */ jsx8("path", { d: "M16 7H10a3 3 0 0 0 0 6h4a3 3 0 0 1 0 6H8", ...S })
  ] }),
  checkbox: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("rect", { x: "4", y: "4", width: "16", height: "16", rx: "3", ...S }),
    /* @__PURE__ */ jsx8("path", { d: "M8 12l3 3 5-6", ...S })
  ] }),
  selectBoxes: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("rect", { x: "4", y: "4", width: "7", height: "7", rx: "1.5", ...S }),
    /* @__PURE__ */ jsx8("rect", { x: "4", y: "14", width: "7", height: "6", rx: "1.5", ...S }),
    /* @__PURE__ */ jsx8("path", { d: "M6 7.5l1.5 1.5L10 6", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "14", y1: "7", x2: "20", y2: "7", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "14", y1: "17", x2: "20", y2: "17", ...S })
  ] }),
  select: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    box,
    /* @__PURE__ */ jsx8("path", { d: "M9 11l3 3 3-3", ...S })
  ] }),
  searchSelect: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    box,
    /* @__PURE__ */ jsx8("circle", { cx: "11", cy: "11", r: "2.5", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "13", y1: "13", x2: "16", y2: "16", ...S })
  ] }),
  radio: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("circle", { cx: "7", cy: "8", r: "3", ...S }),
    /* @__PURE__ */ jsx8("circle", { cx: "7", cy: "8", r: "1", fill: "currentColor", stroke: "none" }),
    /* @__PURE__ */ jsx8("line", { x1: "13", y1: "8", x2: "20", y2: "8", ...S }),
    /* @__PURE__ */ jsx8("circle", { cx: "7", cy: "16", r: "3", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "13", y1: "16", x2: "20", y2: "16", ...S })
  ] }),
  button: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("rect", { x: "3", y: "8", width: "18", height: "8", rx: "4", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "8", y1: "12", x2: "16", y2: "12", ...S })
  ] }),
  datetime: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("rect", { x: "3", y: "5", width: "18", height: "16", rx: "2", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "3", y1: "9", x2: "21", y2: "9", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "8", y1: "3", x2: "8", y2: "7", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "16", y1: "3", x2: "16", y2: "7", ...S })
  ] }),
  day: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("rect", { x: "3", y: "5", width: "18", height: "16", rx: "2", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "3", y1: "9", x2: "21", y2: "9", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "8", y1: "3", x2: "8", y2: "7", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "16", y1: "3", x2: "16", y2: "7", ...S })
  ] }),
  time: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("circle", { cx: "12", cy: "12", r: "8", ...S }),
    /* @__PURE__ */ jsx8("path", { d: "M12 8v4l3 2", ...S })
  ] }),
  tags: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("path", { d: "M4 4h7l9 9-7 7-9-9V4z", ...S }),
    /* @__PURE__ */ jsx8("circle", { cx: "8", cy: "8", r: "1.3", fill: "currentColor", stroke: "none" })
  ] }),
  file: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("path", { d: "M12 16V6m0 0l-4 4m4-4l4 4", ...S }),
    /* @__PURE__ */ jsx8("path", { d: "M5 18a3 3 0 0 0 3 3h8a3 3 0 0 0 3-3", ...S })
  ] }),
  signature: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("path", { d: "M3 18c3 0 4-9 6-9s2 6 4 6 2-4 4-4", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "3", y1: "21", x2: "21", y2: "21", ...S })
  ] }),
  panel: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("rect", { x: "3", y: "5", width: "18", height: "14", rx: "2", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "3", y1: "9", x2: "21", y2: "9", ...S })
  ] }),
  well: /* @__PURE__ */ jsx8("rect", { x: "3", y: "6", width: "18", height: "12", rx: "3", ...S }),
  fieldset: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("rect", { x: "3", y: "6", width: "18", height: "13", rx: "2", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "7", y1: "6", x2: "13", y2: "6", stroke: "var(--lf-bg,#fff)", strokeWidth: "3" })
  ] }),
  columns: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("rect", { x: "3", y: "5", width: "7", height: "14", rx: "1.5", ...S }),
    /* @__PURE__ */ jsx8("rect", { x: "14", y: "5", width: "7", height: "14", rx: "1.5", ...S })
  ] }),
  tabs: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("path", { d: "M3 8h6l1-2h4l1 2h6", ...S }),
    /* @__PURE__ */ jsx8("rect", { x: "3", y: "8", width: "18", height: "11", rx: "2", ...S })
  ] }),
  table: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("rect", { x: "3", y: "5", width: "18", height: "14", rx: "2", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "3", y1: "10", x2: "21", y2: "10", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "3", y1: "15", x2: "21", y2: "15", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "12", y1: "5", x2: "12", y2: "19", ...S })
  ] }),
  content: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("line", { x1: "4", y1: "7", x2: "20", y2: "7", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "4", y1: "12", x2: "20", y2: "12", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "4", y1: "17", x2: "14", y2: "17", ...S })
  ] }),
  heading: /* @__PURE__ */ jsx8(Fragment5, { children: /* @__PURE__ */ jsx8("path", { d: "M6 5v14M18 5v14M6 12h12", ...S }) }),
  divider: /* @__PURE__ */ jsx8("line", { x1: "3", y1: "12", x2: "21", y2: "12", ...S }),
  dataGrid: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("rect", { x: "3", y: "5", width: "18", height: "14", rx: "2", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "3", y1: "10", x2: "21", y2: "10", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "3", y1: "14.5", x2: "21", y2: "14.5", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "11", y1: "5", x2: "11", y2: "19", ...S })
  ] }),
  editGrid: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("rect", { x: "3", y: "5", width: "18", height: "14", rx: "2", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "3", y1: "11", x2: "21", y2: "11", ...S }),
    /* @__PURE__ */ jsx8("path", { d: "M14 16l2-2 2 2-2 2h-2v-2z", ...S })
  ] }),
  page: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("rect", { x: "5", y: "3", width: "14", height: "18", rx: "2", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "8", y1: "8", x2: "16", y2: "8", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "8", y1: "12", x2: "16", y2: "12", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "8", y1: "16", x2: "13", y2: "16", ...S })
  ] }),
  array: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("path", { d: "M7 4H4v16h3", ...S }),
    /* @__PURE__ */ jsx8("path", { d: "M17 4h3v16h-3", ...S }),
    /* @__PURE__ */ jsx8("circle", { cx: "9.5", cy: "12", r: "1.1", fill: "currentColor", stroke: "none" }),
    /* @__PURE__ */ jsx8("circle", { cx: "12", cy: "12", r: "1.1", fill: "currentColor", stroke: "none" }),
    /* @__PURE__ */ jsx8("circle", { cx: "14.5", cy: "12", r: "1.1", fill: "currentColor", stroke: "none" })
  ] }),
  payment: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("rect", { x: "3", y: "6", width: "18", height: "12", rx: "2", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "3", y1: "10", x2: "21", y2: "10", ...S }),
    /* @__PURE__ */ jsx8("line", { x1: "6", y1: "14.5", x2: "10", y2: "14.5", ...S })
  ] }),
  map: /* @__PURE__ */ jsxs8(Fragment5, { children: [
    /* @__PURE__ */ jsx8("path", { d: "M8.5 4C6.5 4 6.5 6 6.5 8s0 4-2 4c2 0 2 2 2 4s0 4 2 4", ...S }),
    /* @__PURE__ */ jsx8("path", { d: "M15.5 4c2 0 2 2 2 4s0 4 2 4c-2 0-2 2-2 4s0 4-2 4", ...S })
  ] })
};
var GENERIC = /* @__PURE__ */ jsxs8(Fragment5, { children: [
  box,
  /* @__PURE__ */ jsx8("line", { x1: "7", y1: "12", x2: "14", y2: "12", ...S })
] });
function paletteIcon(type) {
  return /* @__PURE__ */ jsx8(Svg, { children: ICONS[type] ?? GENERIC });
}
...
function Palette({
  ...
  return /* @__PURE__ */ jsxs9("div", { className: "lf-palette", "aria-label": "Field palette", children: [
    /* @__PURE__ */ jsxs9("h4", { children: [
      "Add field",
      intoContainer ? ` \u2192 into ${labelOf(sel)}` : ""
    ] }),
    /* @__PURE__ */ jsxs9("div", { className: "lf-palette-search-wrap", children: [
      /* @__PURE__ */ jsxs9("svg", { className: "lf-palette-search-icon", viewBox: "0 0 24 24", width: "15", height: "15", "aria-hidden": "true", focusable: "false", children: [
        /* @__PURE__ */ jsx9("circle", { cx: "11", cy: "11", r: "7", fill: "none", stroke: "currentColor", strokeWidth: "2" }),
        /* @__PURE__ */ jsx9("line", { x1: "16.5", y1: "16.5", x2: "21", y2: "21", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round" })
      ] }),
      /* @__PURE__ */ jsx9(
        "input",
        {
      ...
      query && /* @__PURE__ */ jsx9("button", { type: "button", className: "lf-palette-search-clear", "aria-label": "Clear search", onClick: () => setQuery(""), children: /* @__PURE__ */ jsx9(IconX, { size: 13 }) })
    ] }),
    groups.map(({ group, items }) => {
      const visible = items.filter(matches);
      if (visible.length === 0) return null;
      return /* @__PURE__ */ jsxs9("div", { className: "lf-palette-group", children: [
        /* @__PURE__ */ jsx9("h5", { className: "lf-palette-group-title", children: group }),
        visible.map((p) => /* @__PURE__ */ jsxs9(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsx9("span", { className: "lf-palette-item-icon", "aria-hidden": "true", children: paletteIcon(p.type) }),
              /* @__PURE__ */ jsx9("span", { className: "lf-palette-item-label", children: p.label })
            ]
          },
          `${p.type}:${p.label}`
        ))
...
function CanvasDndProvider({ builder, children }) {
  ...
  return /* @__PURE__ */ jsx10(DndContext.Provider, { value: dnd, children });
}
function Canvas({ builder, components, registry }) {
  ...
  return /* @__PURE__ */ jsx10(PreviewContext.Provider, { value: preview, children: /* @__PURE__ */ jsxs10(
    "div",
    {
      ...
      children: [
        schema.root.length === 0 ? /* @__PURE__ */ jsx10("p", { className: "lf-canvas-empty", children: "Add a field to begin \u2014 drag one from the palette, or click it." }) : /* @__PURE__ */ jsx10("ol", { className: "lf-node-list", children: schema.root.map((id, i) => /* @__PURE__ */ jsx10(Node, { id, parentId: null, index: i, count: schema.root.length, builder, depth: 0 }, id)) }),
        /* @__PURE__ */ jsx10("span", { id: kbdHelpId, style: SR_ONLY, children: "Press Space or Enter to pick up, then the arrow keys to move (up/down to reorder, right to nest into the item above, left to move out). Press Space or Enter to drop, or Escape to cancel." }),
        /* @__PURE__ */ jsx10("div", { "aria-live": "assertive", style: SR_ONLY, children: dnd.announcement })
      ]
    }
  ) });
}
...
function Node({
  ...
  return /* @__PURE__ */ jsxs10("li", { className: `lf-node${isContainer ? " is-container" : ""}`, "data-depth": depth, children: [
    over === "before" && /* @__PURE__ */ jsx10(DropIndicator, { pos: "before" }),
    /* @__PURE__ */ jsxs10(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs10("div", { className: "lf-node-body", onClick: () => builder.select(id), children: [
            /* @__PURE__ */ jsxs10("button", { type: "button", className: "lf-node-select", "aria-pressed": selected, "aria-label": `Edit ${labelOf(entity)}`, onClick: () => builder.select(id), children: [
              isContainer && /* @__PURE__ */ jsx10("span", { className: "lf-node-label", children: labelOf(entity) }),
              /* @__PURE__ */ jsx10("span", { className: "lf-node-type", children: entity.type }),
              hidden && /* @__PURE__ */ jsx10("span", { className: "lf-node-badge", children: "Hidden" })
            ] }),
            ...
            /* @__PURE__ */ jsx10("div", { className: "lf-node-preview", "aria-hidden": "true", inert: true, children: /* @__PURE__ */ jsx10(NodePreview, { entity, field: fs, components }) })
          ] }),
          /* @__PURE__ */ jsxs10("span", { className: "lf-node-actions", children: [
            /* @__PURE__ */ jsx10("button", { type: "button", "aria-label": `Move ${labelOf(entity)} up`, disabled: index === 0, onClick: () => builder.reorderField(parentId, index, index - 1), children: /* @__PURE__ */ jsx10(IconArrowUp, { size: 15 }) }),
            /* @__PURE__ */ jsx10("button", { type: "button", "aria-label": `Move ${labelOf(entity)} down`, disabled: index === count - 1, onClick: () => builder.reorderField(parentId, index, index + 1), children: /* @__PURE__ */ jsx10(IconArrowDown, { size: 15 }) }),
            /* @__PURE__ */ jsx10("button", { type: "button", "aria-label": `Duplicate ${labelOf(entity)}`, onClick: () => builder.duplicateField(id), children: /* @__PURE__ */ jsx10(IconDuplicate, { size: 15 }) }),
            /* @__PURE__ */ jsx10("button", { type: "button", "aria-label": `Delete ${labelOf(entity)}`, onClick: () => builder.removeField(id), children: /* @__PURE__ */ jsx10(IconX, { size: 15 }) })
          ] })
        ]
      }
    ),
    isContainer && /* @__PURE__ */ jsxs10(
      "div",
      {
        ...
        children: [
          entity.type === "table" && children.length > 0 && (() => {
            ...
            return /* @__PURE__ */ jsx10("ol", { className: "lf-node-list lf-node-table", "data-cols": cols, style: { display: "grid", gridTemplateColumns: `repeat(${cols}, minmax(0, 1fr))`, alignItems: "stretch" }, children: Array.from({ length: rows * cols }, (_, i) => {
              const cid = children[i];
              return cid ? /* @__PURE__ */ jsx10(Node, { id: cid, parentId: id, index: i, count: children.length, builder, depth: depth + 1 }, cid) : /* @__PURE__ */ jsx10("li", { className: "lf-node-cell-empty", "aria-hidden": "true" }, `empty-${i}`);
            }) });
          })(),
          entity.type !== "table" && children.length > 0 && (() => {
            ...
            const nodeOf = (cid) => /* @__PURE__ */ jsx10(Node, { id: cid, parentId: id, index: children.indexOf(cid), count: children.length, builder, depth: depth + 1 }, cid);
            return /* @__PURE__ */ jsxs10(Fragment6, { children: [
              ...
              belowIds.length > 0 && /* @__PURE__ */ jsx10("ol", { className: "lf-node-list lf-node-list--offgrid", children: belowIds.map(nodeOf) })
            ] });
          })(),
          entity.type === "tabs" && /* @__PURE__ */ jsx10("button", { type: "button", className: "lf-add-tab", onClick: () => builder.addField("panel", { label: `Tab ${children.length + 1}` }, { parentId: id }), children: "+ Add tab" }),
          /* @__PURE__ */ jsx10(ContainerDropzone, { containerId: id, label: labelOf(entity), compact: children.length > 0, index: children.length })
        ]
      }
    ),
    over === "after" && /* @__PURE__ */ jsx10(DropIndicator, { pos: "after" })
  ] });
}
function DropIndicator({ pos }) {
  return /* @__PURE__ */ jsx10("div", { className: `lf-drop-indicator is-${pos}`, "aria-hidden": "true", children: /* @__PURE__ */ jsx10("span", { className: "lf-drop-dot" }) });
}
...
function useCanvasDnd(builder) {
  ...
  const [over, setOver] = useState8(null);
  const [overEmpty, setOverEmpty] = useState8(null);
  const [dragging, setDragging] = useState8(false);
  const [grabbedId, setGrabbedId] = useState8(null);
...
import { useMemo as useMemo4, useState as useState9, useEffect as useEffect8, useRef as useRef6 } from "react";
...
function PreviewModal({
  ...
  const [view, setView] = useState9("form");
  const [copied, setCopied] = useState9(false);
  const [submitResult, setSubmitResult] = useState9(null);
  ...
  return createPortal(
    /* @__PURE__ */ jsx11("div", { className: "lf-modal-overlay lf-builder", onMouseDown: (e) => e.target === e.currentTarget && onClose(), children: /* @__PURE__ */ jsxs11("div", { ref: dialogRef, className: "lf-modal lf-preview-modal", role: "dialog", "aria-modal": "true", "aria-label": "Form preview", tabIndex: -1, children: [
      /* @__PURE__ */ jsxs11("div", { className: "lf-modal-header", children: [
        /* @__PURE__ */ jsx11("span", { className: "lf-modal-title", children: "Preview" }),
        /* @__PURE__ */ jsxs11("div", { className: "lf-modal-actions", children: [
          /* @__PURE__ */ jsxs11("div", { className: "lf-seg", role: "tablist", "aria-label": "Preview mode", children: [
            /* @__PURE__ */ jsx11("button", { type: "button", role: "tab", "aria-selected": view === "form", className: `lf-seg-btn${view === "form" ? " is-active" : ""}`, onClick: () => setView("form"), children: "Form" }),
            /* @__PURE__ */ jsx11("button", { type: "button", role: "tab", "aria-selected": view === "json", className: `lf-seg-btn${view === "json" ? " is-active" : ""}`, onClick: () => setView("json"), children: "JSON" })
          ] }),
          view === "json" && /* @__PURE__ */ jsx11("button", { type: "button", className: "lf-modal-ghost", onClick: copyJson, children: copied ? "Copied \u2713" : "Copy" }),
          /* @__PURE__ */ jsxs11("button", { type: "button", className: "lf-modal-ghost", onClick: openInNewTab, children: [
            /* @__PURE__ */ jsx11(IconExternal, {}),
            "Open in new tab"
          ] }),
          /* @__PURE__ */ jsx11("button", { type: "button", className: "lf-iconbtn lf-iconbtn--close", "aria-label": "Close preview", title: "Close", onClick: onClose, children: "\u2715" })
        ] })
      ] }),
      /* @__PURE__ */ jsx11("div", { className: "lf-modal-body", children: view === "form" ? /* @__PURE__ */ jsxs11(Fragment7, { children: [
        /* @__PURE__ */ jsx11("div", { className: "lf-builder-preview", "data-testid": "preview", children: /* @__PURE__ */ jsx11(
          FormRenderer,
          {
            schema,
            components,
        ...
        submitResult && (submitResult.ok ? /* @__PURE__ */ jsxs11("div", { className: "lf-preview-result is-ok", role: "status", "data-testid": "preview-result", children: [
          /* @__PURE__ */ jsx11("strong", { children: "\u2713 Valid \u2014 submission payload" }),
          /* @__PURE__ */ jsx11("pre", { className: "lf-json", children: JSON.stringify(submitResult.data ?? {}, null, 2) })
        ] }) : /* @__PURE__ */ jsxs11("div", { className: "lf-preview-result is-error", role: "status", "data-testid": "preview-result", children: [
          /* @__PURE__ */ jsxs11("strong", { children: [
            "\u2715 ",
            submitResult.errorKeys?.length ?? 0,
            " field(s) need attention"
          ] }),
          submitResult.errorKeys && submitResult.errorKeys.length > 0 && /* @__PURE__ */ jsxs11("span", { className: "lf-preview-result-keys", children: [
            " \u2014 ",
            submitResult.errorKeys.join(", ")
          ] })
        ] }))
      ] }) : /* @__PURE__ */ jsx11("pre", { className: "lf-json", "data-testid": "preview-json", children: json }) })
    ] }) }),
    document.body
  );
}
function openPreviewWindow(schema, opts) {
  ...
  root.render(/* @__PURE__ */ jsx11(FormRenderer, { schema, components: opts?.components, registry: opts?.registry }));
  const teardown = () => {
    try {
      root.unmount();
    } catch {
...
import { useState as useState10, useEffect as useEffect9, useRef as useRef7 } from "react";
...
function SettingsModal({ builder, editors, notify }) {
  ...
  const [confirmDiscard, setConfirmDiscard] = useState10(false);
  ...
  return createPortal2(
    /* @__PURE__ */ jsx12(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs12("div", { ref: dialogRef, className: "lf-modal", role: "dialog", "aria-modal": "true", "aria-label": "Field settings", tabIndex: -1, children: [
          /* @__PURE__ */ jsxs12("div", { className: "lf-modal-header", children: [
            /* @__PURE__ */ jsxs12("span", { className: "lf-modal-title", children: [
              "Field settings",
              dirty ? /* @__PURE__ */ jsx12("span", { className: "lf-modal-dirty", children: " \u2022 Unsaved changes" }) : null
            ] }),
            /* @__PURE__ */ jsx12("div", { className: "lf-modal-actions", children: dirty ? /* @__PURE__ */ jsxs12(Fragment8, { children: [
              /* @__PURE__ */ jsx12("button", { type: "button", className: "lf-iconbtn lf-iconbtn--discard", "aria-label": "Discard & close", title: "Discard & close", onClick: () => setConfirmDiscard(true), children: /* @__PURE__ */ jsx12(IconX, {}) }),
              /* @__PURE__ */ jsx12("button", { type: "button", className: "lf-iconbtn lf-iconbtn--save", "aria-label": "Save & close", title: "Save & close", onClick: () => saveClose(true), children: /* @__PURE__ */ jsx12(IconCheck, {}) })
            ] }) : /* @__PURE__ */ jsx12("button", { type: "button", className: "lf-iconbtn lf-iconbtn--close", "aria-label": "Close", title: "Close", onClick: close, children: /* @__PURE__ */ jsx12(IconX, {}) }) })
          ] }),
          /* @__PURE__ */ jsx12("div", { className: "lf-modal-body", children: /* @__PURE__ */ jsx12(SettingsPanel, { builder, editors }) }),
          confirmDiscard && /* @__PURE__ */ jsx12("div", { className: "lf-confirm-overlay", onMouseDown: (e) => e.target === e.currentTarget && setConfirmDiscard(false), children: /* @__PURE__ */ jsxs12("div", { className: "lf-confirm", role: "alertdialog", "aria-modal": "true", "aria-label": "Discard changes?", children: [
            /* @__PURE__ */ jsx12("p", { className: "lf-confirm-msg", children: "Are you sure? All your changes for this field will be lost." }),
            /* @__PURE__ */ jsxs12("div", { className: "lf-confirm-actions", children: [
              /* @__PURE__ */ jsx12("button", { type: "button", className: "lf-confirm-no", onClick: () => setConfirmDiscard(false), children: "No" }),
              /* @__PURE__ */ jsx12("button", { type: "button", className: "lf-confirm-yes", onClick: doDiscard, children: "Yes, discard" })
            ] })
          ] }) })
        ] })
      }
...
function ProblemsBadge({ builder }) {
  ...
  return /* @__PURE__ */ jsx13("span", { "aria-live": "polite", className: n === 0 ? "lf-problems-badge is-ok" : `lf-problems-badge${builder.hasErrors ? " is-error" : " is-warning"}`, children: n === 0 ? "No problems" : `${n} problem${n === 1 ? "" : "s"}` });
}
function Problems({ builder }) {
  if (builder.problems.length === 0) return null;
  return /* @__PURE__ */ jsx13("div", { className: "lf-problems", role: "region", "aria-label": "Problems", children: /* @__PURE__ */ jsx13("ul", { children: builder.problems.map((d, i) => /* @__PURE__ */ jsx13("li", { className: `lf-problem is-${d.severity}`, children: /* @__PURE__ */ jsxs13("button", { type: "button", disabled: !d.entityId, onClick: () => d.entityId && builder.select(d.entityId), children: [
    /* @__PURE__ */ jsx13("span", { className: "lf-problem-code", children: d.code }),
    " ",
    d.message
  ] }) }, i)) }) });
}
...
function IconDownload() {
  return /* @__PURE__ */ jsxs14("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true", children: [
    /* @__PURE__ */ jsx14("path", { d: "M12 3v12" }),
    /* @__PURE__ */ jsx14("path", { d: "m7 11 5 5 5-5" }),
    /* @__PURE__ */ jsx14("path", { d: "M5 21h14" })
  ] });
}
...
function DataStructureView({ schema, registry, onSelect, formName, onGenerateTemplate }) {
  ...
  return /* @__PURE__ */ jsxs14("div", { className: "lf-ds", role: "region", "aria-label": "Data structure", children: [
    /* @__PURE__ */ jsxs14("div", { className: "lf-ds-bar", children: [
      /* @__PURE__ */ jsxs14("div", { className: "lf-ds-bar-heading", children: [
        /* @__PURE__ */ jsx14("span", { className: "lf-ds-bar-title", children: "Data structure" }),
        /* @__PURE__ */ jsxs14("span", { className: "lf-ds-count", children: [
          n,
          " field",
          n === 1 ? "" : "s"
        ] })
      ...
      /* @__PURE__ */ jsxs14(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsx14(IconDownload, {}),
            "Generate template"
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxs14("div", { className: "lf-ds-panes", children: [
      /* @__PURE__ */ jsxs14("section", { className: "lf-ds-pane lf-ds-tree", children: [
        /* @__PURE__ */ jsx14("header", { className: "lf-ds-pane-head", children: /* @__PURE__ */ jsx14("span", { className: "lf-ds-pane-title", children: "Fields" }) }),
        n === 0 ? /* @__PURE__ */ jsx14("p", { className: "lf-ds-empty", children: "Add fields to the form to see the data it produces." }) : /* @__PURE__ */ jsx14("ul", { className: "lf-ds-list", children: contract.fields.map((f) => /* @__PURE__ */ jsx14(FieldRow, { field: f, onSelect }, f.entityId)) })
      ] }),
      /* @__PURE__ */ jsxs14("section", { className: "lf-ds-pane lf-ds-json", children: [
        /* @__PURE__ */ jsxs14("header", { className: "lf-ds-pane-head", children: [
          /* @__PURE__ */ jsx14("span", { className: "lf-ds-pane-title", children: "Example submission" }),
          /* @__PURE__ */ jsx14("span", { className: "lf-ds-count", children: "JSON" })
        ] }),
        /* @__PURE__ */ jsx14("pre", { className: "lf-ds-code", "aria-label": "Example submission JSON", children: /* @__PURE__ */ jsx14("code", { children: json }) })
      ] })
    ] })
  ] });
}
function FieldRow({ field, onSelect }) {
  ...
  return /* @__PURE__ */ jsxs14("li", { className: "lf-ds-item", children: [
    /* @__PURE__ */ jsxs14("div", { className: `lf-ds-row${field.excluded ? " is-excluded" : ""}`, children: [
      selectable ? /* @__PURE__ */ jsx14("button", { type: "button", className: "lf-ds-key lf-ds-key--btn", onClick: () => onSelect(field.entityId), title: "Select this field on the canvas", children: field.key }) : /* @__PURE__ */ jsx14("span", { className: "lf-ds-key", children: field.key }),
      /* @__PURE__ */ jsx14("span", { className: "lf-ds-type", children: field.typeLabel }),
      /* @__PURE__ */ jsx14("span", { className: "lf-ds-accepts", children: field.accepts }),
      field.constraints.map((c) => /* @__PURE__ */ jsx14("span", { className: "lf-ds-chip", children: c }, c)),
      field.conditional && /* @__PURE__ */ jsx14("span", { className: "lf-ds-chip is-cond", title: "Shown conditionally \u2014 may be absent from a given submission", children: "conditional" }),
      field.excluded && /* @__PURE__ */ jsx14("span", { className: "lf-ds-chip is-excl", title: "persistent: false \u2014 excluded from the submission payload", children: "not saved" })
    ] }),
    children.length > 0 && /* @__PURE__ */ jsx14("ul", { className: "lf-ds-list lf-ds-children", children: children.map((c) => /* @__PURE__ */ jsx14(FieldRow, { field: c, onSelect }, c.entityId)) })
  ] });
}

// src/FormBuilder.tsx
import { jsx as jsx15, jsxs as jsxs15 } from "react/jsx-runtime";
var FormBuilder = forwardRef(function FormBuilder2({ initialSchema, onChange, extraFields, hiddenFields, components, registry, attributeEditors, settings = "panel", aside, hidePreview, formName, onGenerateTemplate, hideDataView, className }, ref) {
  ...
  return /* @__PURE__ */ jsxs15("div", { className: `lf-builder ${className ?? ""}`, children: [
    /* @__PURE__ */ jsxs15("div", { className: "lf-builder-toolbar", children: [
      /* @__PURE__ */ jsxs15("button", { type: "button", onClick: b.undo, disabled: !b.canUndo, "aria-label": "Undo", title: "Undo (\u2318/Ctrl+Z)", children: [
        /* @__PURE__ */ jsx15(IconUndo, {}),
        "Undo"
      ] }),
      /* @__PURE__ */ jsxs15("button", { type: "button", onClick: b.redo, disabled: !b.canRedo, "aria-label": "Redo", title: "Redo (\u2318/Ctrl+Shift+Z)", children: [
        /* @__PURE__ */ jsx15(IconRedo, {}),
        "Redo"
      ] }),
      !hidePreview && /* @__PURE__ */ jsxs15("button", { type: "button", onClick: () => setShowPreview(true), title: "Preview the form", children: [
        /* @__PURE__ */ jsx15(IconEye, {}),
        "Preview"
      ] }),
      !hideDataView && /* @__PURE__ */ jsxs15("div", { className: "lf-builder-viewtoggle", role: "group", "aria-label": "Builder view", children: [
        /* @__PURE__ */ jsx15("button", { type: "button", className: view === "design" ? "is-active" : "", "aria-pressed": view === "design", onClick: () => setView("design"), children: "Design" }),
        /* @__PURE__ */ jsx15("button", { type: "button", className: view === "data" ? "is-active" : "", "aria-pressed": view === "data", onClick: () => setView("data"), title: "See the data structure this form produces", children: "Data" })
      ] }),
      /* @__PURE__ */ jsx15(ProblemsBadge, { builder: b })
    ] }),
    /* @__PURE__ */ jsxs15(CanvasDndProvider, { builder: b, children: [
      view === "data" && !hideDataView ? /* @__PURE__ */ jsx15("div", { className: "lf-ds-shell", children: /* @__PURE__ */ jsx15(
        DataStructureView,
        {
          schema: b.schema,
          registry,
      ...
      ) }) : /* @__PURE__ */ jsxs15("div", { className: `lf-builder-body${modal ? " lf-builder-body--modal" : ""}${modal && aside ? " lf-builder-body--aside" : ""}`, children: [
        /* @__PURE__ */ jsx15(Palette, { builder: b, extra: extraFields, hidden: hiddenFields }),
        /* @__PURE__ */ jsx15(Canvas, { builder: b, components, registry }),
        modal ? aside && /* @__PURE__ */ jsx15("aside", { className: "lf-builder-aside", children: aside }) : /* @__PURE__ */ jsx15(SettingsPanel, { builder: b, editors })
      ] }),
      modal && /* @__PURE__ */ jsx15(SettingsModal, { builder: b, editors, notify: setToast })
    ] }),
    showPreview && /* @__PURE__ */ jsx15(PreviewModal, { schema: b.schema, components, registry, onClose: () => setShowPreview(false), notify: setToast }),
    /* @__PURE__ */ jsx15(Problems, { builder: b }),
    toast && createPortal3(
      /* @__PURE__ */ jsxs15("div", { className: "lf-toast lf-builder", role: "status", children: [
        /* @__PURE__ */ jsx15("span", { className: "lf-toast-tick", "aria-hidden": "true", children: /* @__PURE__ */ jsx15(IconCheck, {}) }),
        " ",
        toast
      ] }),
      document.body
